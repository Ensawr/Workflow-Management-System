<?php
session_start();
require "../../Controllers/feeders/product_edit_feeder.php";
...
<head>
    ...
    <title>Product Photo Edit</title>
</head>
<body>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <a href="product_edit_2.php?data&barcode=<?php echo $data[3] ?>" target="_blank">View</a>
                      </td>
                    </tr>
                <?php } ?>
            </tbody>
